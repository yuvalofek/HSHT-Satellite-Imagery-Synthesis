...
if args.dataset == "vimeo90K_septuplet":
    ...
    train_loader = get_loader(paths, tr_idx, args.batch_size, shuffle=True, num_workers=args.num_workers, is_training=True, inter_frames=args.n_outputs, n_inputs=args.nbr_frame, channels=args.channels, ic=args.ic)
    test_loader = get_loader(paths, test_idx, args.batch_size, shuffle=False, num_workers=args.num_workers, is_training=False, inter_frames=args.n_outputs, n_inputs=args.nbr_frame, channels=args.channels, ic=args.ic)
else:
